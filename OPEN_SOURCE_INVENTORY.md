...
- macOS Apple Silicon 開發與 ad-hoc App 建置腳本。
- App icon、GPLv3、商業授權說明、安全政策及開發文件。
- 第三方相依套件清冊產生工具。

## 不公開

- `cert/` 內所有憑證、私鑰、P12、Provisioning Profile 與個人簽章說明。
- App Store、TestFlight、Developer ID notarization、PKG、DMG 與商店審查腳本或文件。
...
- 每次發布前重新掃描 Token、私鑰、憑證、Provisioning Profile、個人路徑與大型二進位檔。
